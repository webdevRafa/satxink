...
import { Camera, Expand, ImageOff, X } from "lucide-react";
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 mt-20 min-h-[80vh]">
      ...
      <div className="mt-10">
        <div
          data-aos="fade-up"
          className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between mb-5"
        >
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-white/40 mb-2">
              Recent work
            </p>
            <h2 className="text-2xl! font-semibold! text-white my-0!">
              Portfolio
            </h2>
          </div>
        ...
        {galleryLoading ? (
          ...
          <div className="flex min-h-[260px] flex-col items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] px-6 text-center">
            ...
            <h3 className="text-lg! font-semibold! text-white my-0!">
              No portfolio pieces yet
            </h3>
            <p className="mt-2 max-w-md text-sm text-white/50">
              This artist has not published gallery work to their public portfolio.
            </p>
          </div>
        )}
      </div>
...
const getGalleryTime = (item: GalleryItem) => {
...
const PortfolioCard = ({
  ...
  <button
    ...
    data-aos="fade-up"
    onClick={onOpen}
    className={`group relative overflow-hidden rounded-xl border border-white/10 bg-[#111] p-0! text-left shadow-[0_18px_50px_rgba(0,0,0,0.28)] transition duration-300 hover:-translate-y-1 hover:border-white/25 hover:shadow-[0_22px_70px_rgba(0,0,0,0.45)] ${
