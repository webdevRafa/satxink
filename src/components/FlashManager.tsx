                ...
                <div className="p-5 pb-0 md:p-6">
                  ...
                  <div className="sticky bottom-0 -mx-5 mt-6 grid grid-cols-2 gap-2.5 border-t border-white/10 bg-[#111111]/95 p-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] backdrop-blur md:static md:mx-0 md:mt-7 md:flex md:justify-end md:border-t-0 md:bg-transparent md:p-0 md:backdrop-blur-none">
                    <button
                      type="button"
                      onClick={closeSheetTitleModal}
                      className="flash-sheet-modal-action min-w-0 rounded-lg! border border-white/10 bg-white/5 px-3! py-2! text-xs! font-semibold text-zinc-300 transition hover:bg-white/10 hover:text-white md:px-4!"
                      disabled={isUploadingSheet}
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className={`flash-sheet-modal-action min-w-0 rounded-lg! px-3! py-2! text-xs! font-semibold transition disabled:cursor-not-allowed md:px-4! ${
