    ...
    <div className="rounded-lg border border-white/10 bg-[#111111] shadow-lg">
      <div className="request-modal-scrollbar overflow-x-auto rounded-lg">
        <div className="min-w-[1160px]">
          <div
            className="sticky top-20 z-20 grid items-center border-b border-white/10 bg-[#171717]/95 px-3 py-3 text-[11px] uppercase tracking-[0.14em] text-neutral-500 shadow-[0_8px_24px_rgba(0,0,0,0.28)] backdrop-blur"
