...
const BookingRequestsList: React.FC<Props> = ({
  ...
  return (
    <>
      <div className="z-50 sticky top-32 md:top-19  py-3 px-2 mb-4 flex flex-wrap items-center gap-4 w-full">
        <select
          value={selectedMonth}
                          ...
                          <div>
                            ...
                            <div className="flex  gap-2 md:gap-3 md:mt-10">
                              ...
                              <button
                                ...
                                className="bg-[#121212] border-2 border-neutral-500 hover:border-emerald-400 text-white! w-full text-sm p-0! rounded flex gap-1 justify-center items-center max-w-[200px]"
                              >
                                Make an offer
                                <img
